package taiwriting.android.khurkham.dev.gifmakerlib;
...
public class GifMaker extends View {
    ...
    public GifMaker(Context context) throws IOException {
        super(context);
    }

    public GifMaker(Context context, AttributeSet attrSet) throws IOException{
        super(context, attrSet);
    }

    public GifMaker(Context context, AttributeSet attrSet, int newStyle) throws IOException {
